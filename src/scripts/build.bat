...
set CWD=%cd%
set SDK_DIR=%CWD%\sdk
set SDK_URL=https://github.com/friction2d/friction-sdk/releases/download/20240805/friction-sdk-20240805-windows-x64.7z
set SDK_ARCHIVE=friction-sdk-20240805-windows-x64.7z
...
cmake -G "Visual Studio 18 2026" -A x64 -DCMAKE_BUILD_TYPE=%BTYPE% -DCMAKE_PREFIX_PATH=%SDK_DIR% -DCUSTOM_BUILD=%CBUILD% -DBUILD_SKIA=OFF -DFRICTION_OFFICIAL_RELEASE=%REL% -DWIN_DEPLOY=ON -DGIT_COMMIT=%COMMIT% -DGIT_BRANCH=%BRANCH% ..
