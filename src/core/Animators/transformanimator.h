...
public:
    ...
    virtual SkM44 getRelativeTransform3DAtFrame(const qreal relFrame, SkM44* postTransform = nullptr) const;
    virtual SkM44 getTotalTransform3DAtFrame(const qreal relFrame) const;
    ...
    QrealAnimator *getZDepthAnimator() const;
    QrealAnimator *getXRotAnimator() const;
    QrealAnimator *getYRotAnimator() const;
...
protected:
    ...
    qsptr<QrealAnimator> mZDepthAnimator;
    qsptr<QrealAnimator> mXRotAnimator;
    qsptr<QrealAnimator> mYRotAnimator;
